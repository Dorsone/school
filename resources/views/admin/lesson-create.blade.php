                ...
                <form action="{{route('admin.lessons.store')}}" enctype="multipart/form-data" method="POST">
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <textarea name="title_uz" id="title_uz" class="form-control @error('title_uz') is-invalid @enderror"></textarea>
                            @error('title_uz')
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <textarea name="description_uz" id="description_uz" class="form-control @error('description_uz') is-invalid @enderror"></textarea>
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <textarea name="title_ru" id="title_ru" class="form-control @error('title_ru') is-invalid @enderror"></textarea>
                            @error('title_ru')
                            <span id="password_confirmation-error" class="error invalid-feedback">{{__($message)}}</span>
                            @enderror
                        </div>
                        <div class="form-group col-md-6">
                            ...
                            <textarea name="description_ru" id="description_ru" class="form-control @error('description_ru') is-invalid @enderror"></textarea>
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <textarea name="title_en" id="title_en" class="form-control @error('title_en') is-invalid @enderror"></textarea>
                            @error('title_en')
                            <span id="password_confirmation-error" class="error invalid-feedback ">{{__($message)}}</span>
                            @enderror
                        </div>
                    ...
                    <div class="row">
                        <div class="form-group col-md-4">
                            ...
                            <input name="from_time" id="from_time" type="time" class="form-control @error('from_time') is-invalid @enderror">
                            @error('from_time')
                            <span id="password_confirmation-error" class="error invalid-feedback">{{__($message)}}</span>
                            @enderror
                        </div>
                        <div class="form-group col-md-4">
                            ...
                            <input name="to_time" id="to_time" type="time" class="form-control @error('to_time') is-invalid @enderror">
                            @error('to_time')
                            <span id="password_confirmation-error" class="error invalid-feedback">{{__($message)}}</span>
                            @enderror
                        </div>
