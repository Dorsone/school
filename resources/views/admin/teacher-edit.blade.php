    ...
    <div class="col-md">
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title">O`qituvchini o'zgartirish</h3>
            </div>
            <div class="card-body">
                ...
                <form action="{{route('admin.teachers.update', $teacher->id)}}" enctype="multipart/form-data" method="POST">
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <input name="name_uz" type="text" id="name_uz" value="{{$teacher->name_uz}}" class="form-control">
                            @error('name_uz')
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input name="role_uz" type="text" id="role_uz" value="{{$teacher->role_uz}}" class="form-control">
                            @error('role_uz')
                            <span id="password_confirmation-error" class="error invalid-feedback">{{__($message)}}</span>
                            @enderror
                        </div>
                    ...
                    <div class="row">
                        <div class="form-group col-md">
                            ...
                            <textarea name="description_uz" id="description_uz" class="form-control">{{$teacher->description_uz}}</textarea>
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <input name="name_ru" type="text" id="name_ru" value="{{$teacher->name_ru}}" class="form-control">
                            @error('name_ru')
                            <span id="password_confirmation-error" class="error invalid-feedback">{{__($message)}}</span>
                            @enderror
                        </div>
                        <div class="form-group col-md-6">
                            ...
                            <input name="role_ru" type="text" id="role_ru" value="{{$teacher->role_ru}}" class="form-control">
                            @error('role_ru')
                            <span id="password_confirmation-error" class="error invalid-feedback">{{__($message)}}</span>
                            @enderror
                        </div>
                    ...
                    <div class="row">
                        <div class="form-group col-md">
                            ...
                            <textarea name="description_ru" id="description_ru" class="form-control">{{$teacher->description_ru}}</textarea>
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <input name="name_en" type="text" value="{{$teacher->name_en}}" id="name_en" class="form-control">
                            @error('image')
                            <span id="password_confirmation-error" class="error invalid-feedback">{{__($message)}}</span>
                            @enderror
                        </div>
                        <div class="form-group col-md-6">
                            ...
                            <input name="role_en" value="{{$teacher->role_en}}" type="text" id="role_en" class="form-control">
                            @error('image')
                            <span id="password_confirmation-error" class="error invalid-feedback">{{__($message)}}</span>
                            @enderror
                        </div>
                    ...
                    <div class="row">
                        <div class="form-group col-md">
                            ...
                            <textarea name="description_en" id="description_en" class="form-control">{{$teacher->description_en}}</textarea>
                            @error('image')
                            <span id="password_confirmation-error" class="error invalid-feedback">{{__($message)}}</span>
                            @enderror
                        </div>
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <input name="facebook" type="text" value="{{$teacher->facebook}}" id="facebook" class="form-control">
                            @error('image')
                            <span id="password_confirmation-error" class="error invalid-feedback">{{__($message)}}</span>
                            @enderror
                        </div>
                        <div class="form-group col-md-6">
                            ...
                            <input name="twitter" type="text" value="{{$teacher->twitter}}" id="twitter" class="form-control">
                            @error('image')
                            <span id="password_confirmation-error" class="error invalid-feedback">{{__($message)}}</span>
                            @enderror
                        </div>
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <input name="instagram" value="{{$teacher->instagram}}" type="text" id="instagram" class="form-control">
                            @error('image')
                            <span id="password_confirmation-error" class="error invalid-feedback">{{__($message)}}</span>
                            @enderror
                        </div>
                        <div class="form-group col-md-6">
                            ...
                            <input name="telegram" value="{{$teacher->telegram}}" type="text" id="telegram" class="form-control">
                            @error('image')
                            <span id="password_confirmation-error" class="error invalid-feedback">{{__($message)}}</span>
                            @enderror
                        </div>
