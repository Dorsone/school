            ...
            <div class="card-body">
                <div class="row">
                    <div class="form-group col-md-4">
                        ...
                        <input name="name" type="text" id="name" value="{{ $article->user->name_uz }}" disabled
                            class="form-control">
                    </div>
                    <div class="form-group col-md-4">
                        <label for="phone">Qisqa sarlavha </label>
                        <input name="phone" type="text" id="phone" value="{{ $article->title_preview_uz }}"
                            disabled class="form-control">
                    </div>
                    <div class="form-group col-md-4">
                        <label for="created_at">Qachon yaratilgan</label>
                        <input name="created_at" type="text" id="created_at"
                            value="{{ $article->created_at->format('d-m-Y H:i') }}" disabled class="form-control">
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input name="phone" type="text" id="phone" value="{{ $article->content_preview_uz }}"
                            disabled class="form-control">
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <input name="phone" type="text" id="phone" value="{{ $article->title_preview_ru }}"
                            disabled class="form-control">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="phone">Qisqa mazmun RU</label>
                        <input name="phone" type="text" id="phone" value="{{ $article->content_preview_ru }}"
                            disabled class="form-control">
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <input name="phone" type="text" id="phone" value="{{ $article->title_preview_en }}"
                            disabled class="form-control">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="phone">Qisqa mazmun EN</label>
                        <input name="phone" type="text" id="phone" value="{{ $article->content_preview_en }}"
                            disabled class="form-control">
                    </div>
                </div>
                <div class="row">
                        ...
                        @if ($article->getMedia()->isNotEmpty())
                            @foreach ($article->getMedia() as $media)
                                <img class="form-control h-auto w-auto" src="{{ $media->getUrl() }}" alt="photo"
                                    style="width: 1cm; height:1cm" id="image" name="images">
                            @endforeach
                        @else
